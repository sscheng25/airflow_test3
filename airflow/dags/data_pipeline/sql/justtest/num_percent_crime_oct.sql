...
total_crime as (
	select count(id) as count_all_crime 
	from `musa-509-final.justtest.crime_2021-11-30`
	where date >='2021-10-01' and date < '2021-11-01'
),
crime_in_nhoods as (
...
select pri_neigh, num_crime, 
num_crime*100/(select count_all_crime from total_crime) as percent_crime
from crime_in_nhoods
